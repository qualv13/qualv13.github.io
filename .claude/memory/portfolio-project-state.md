...
Status: netrunner build merged to main and live; site verified serving built assets + CV. Sections: Hero, About, Experience, Projects (DrugPath/InstalDesk/IoTServerApp/CarCharging/Fit2Beat/hardware-hub), Skills, Achievements+Education, Contact, Footer.
